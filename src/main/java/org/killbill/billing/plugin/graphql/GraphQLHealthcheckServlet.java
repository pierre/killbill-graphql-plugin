...
@Singleton
@Path("/healthcheck")
public class GraphQLHealthcheckServlet extends PluginHealthcheck {

    private final GraphQLHealthcheck healthcheck;

    @Inject
    public GraphQLHealthcheckServlet(final GraphQLHealthcheck healthcheck) {
