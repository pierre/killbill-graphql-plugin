...
public class InvoicePluginApiImp implements InvoicePluginApi {
    ...
    @Override
    public List<InvoiceItem> getAdditionalInvoiceItems(final Invoice invoice, final boolean b, final Iterable<PluginProperty> iterable, final CallContext callContext) {
        return null;
    }
